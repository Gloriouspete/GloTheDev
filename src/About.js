  ...
  return (
    <>
      ...
      <div class="about-me" className="mt-12 px-2 text-center">
        <h1 className="text-2xl font-interbold text-slate-800 mb-4">Professionally,</h1>
        <p className="text-md font-light font-inter mb-2">As a Full stack with expertise in multiple
          ...
          </p><p className="text-md font-light font-inter mb-2">
        ...
        <h1 className="text-2xl font-interbold text-slate-800 mb-4">Personally,</h1>
        <p id="widd">
